...
from config import LOG_REG_MODEL_PATH_FOR_STRATEGY
...
def logistic_regression_strategy(data, **kwargs):
    """
    Generate next-day execution signals using a trained logistic regression model.

    Signals follow the len(data)+1 convention: a leading HOLD to account for
    execution lag, with an extra trailing entry inserted below.
    """
