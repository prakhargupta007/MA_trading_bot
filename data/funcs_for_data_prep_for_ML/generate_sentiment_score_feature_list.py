...
# This conversion could also be helpful in the rule based sentiment strategy as it could determine the position sizing based on sentiment strength, however I haven't implemented that yet and the categorial method is being used there. 